    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApartmentBills", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApartmentBills_Apartments_ApartmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApartmentBillId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_ApartmentBills_ApartmentBillId",
                        column: x => x.ApartmentBillId,
                        principalTable: "ApartmentBills",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Payments_Apartments_ApartmentId1",
                        column: x => x.ApartmentId1,
                        principalTable: "Apartments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Payments_Dues_DuesId",
                        column: x => x.DuesId,
                        principalTable: "Dues",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApartmentBills_ApartmentId",
                table: "ApartmentBills",
                column: "ApartmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_ApartmentBillId",
                table: "Payments",
                column: "ApartmentBillId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_ApartmentId1",
                table: "Payments",
                column: "ApartmentId1");

            migrationBuilder.CreateIndex(
                name: "IX_Payments_DuesId",
                table: "Payments",
                column: "DuesId",
                unique: true,
